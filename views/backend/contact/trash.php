                    ...
                    <tbody>
                        <?php foreach ($list as $row) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-info" href="index.php?option=contact&cat=retore&id=<?= $row['id']; ?>">
                                        <i class="fas fa-undo"></i>
                                    </a>
                                    <a class="btn btn-sm btn-danger" href="index.php?option=contact&cat=destroy&id=<?= $row['id']; ?>">
