...
use App\Models\Menu;
//SELECT * from cqt_Menu WHERE status !=0 ORDER BY created _at DESC
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <a class="btn btn-sm btn-success" href="index.php?option=menu&cat=create">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Tên sản phẩm</th>
                            <th>Tên danh mục</th>
                            <th class="text-center" style="width:20px">link</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a class=" btn btn-sm btn-info " href=" index.php?option=menu&cat=deletel& id=<?= $row['id'] ?>">
