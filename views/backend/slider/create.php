...
foreach ($list as $item) {
    $html_link .= "<option value='" . $item->id . "'>" . $item->name . "</option>";
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="name" id="name" type="text"class="form-control" require placeholder="Dịch vụ,Tin tức,Thông báo..." >
                            </div>
                            <div class="mb-3">
                                <label for="position">Posdition</label>
                                <textarea name="position" id="position" class="form-control" require placeholder="slidershow"></textarea>
